...
ensemble_dir = '/pscratch/sd/j/jerrylin/hugging/E3SM-MMF_ne4/online_runs/JJA_runs'
case_dir = f'{ensemble_dir}/{model_ensemble}'
compiled_esm_path = '/pscratch/sd/j/jerrylin/hugging/E3SM-MMF_ne4/online_runs/JJA_runs/empty_case_JJA/build/e3sm.exe'
long_run = False
email_address = 'jerryL9@uci.edu'

case_prefixes = ['unet_seed_7', 'squeezeformer_seed_43', 'pao_model_seed_7']
