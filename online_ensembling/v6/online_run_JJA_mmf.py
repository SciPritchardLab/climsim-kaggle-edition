...
case_dir = f'{scratch_dir}/hugging/E3SM-MMF_ne4/online_runs/JJA_runs'
...
stop_opt,stop_n,resub,walltime = 'nmonths',3, 0,'3:00:00'
...
#---------------------------------------------------------------------------------------------------
   ...
   jja_source_file = '/global/cfs/cdirs/m4334/jerry/climsim3_ensembles_v6/short_runs/unet_jja_run/user_docn.streams.txt.prescribed'
   run_cmd(f'cp {jja_source_file} {case_scripts_dir}/user_docn.streams.txt.prescribed')
   # updae user_nl_eam 
