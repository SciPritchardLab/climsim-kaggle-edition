...
def main(regexps, save_path, start_idx):
    ...
    input_mean = xr.open_dataset(norm_path + 'inputs/input_mean_adv_ne4_qlog.nc')
    input_max = xr.open_dataset(norm_path + 'inputs/input_max_adv_ne4_qlog.nc')
    input_min = xr.open_dataset(norm_path + 'inputs/input_min_adv_ne4_qlog.nc')
    output_scale = xr.open_dataset(norm_path + 'outputs/output_scale_std.nc')
    ...
    data.save_as_npy(data_split='train', save_path=save_path)
