...
def main(regexps, data_split, stride_sample, start_idx, save_h5, save_path):
    ...
    input_mean = xr.open_dataset(norm_path + 'inputs/input_mean_v6_pervar.nc')
    input_max = xr.open_dataset(norm_path + 'inputs/input_max_v6_pervar.nc')
    input_min = xr.open_dataset(norm_path + 'inputs/input_min_v6_pervar.nc')
    output_scale = xr.open_dataset(norm_path + 'outputs/output_scale_std_lowerthred_v6.nc')
