...
from pao_model_conf_loss import PaoModelConfLoss
from custom_losses import MSELoss_conf, L1Loss_conf, HuberLoss_conf
    ...
    for epoch in range(cfg.epochs):
        ...
        with LaunchLogger("train", epoch=epoch, mini_batch_log_freq=10) as launchlog:
            ...
            if dist.rank == 0:
                ...
                launchlog.log_epoch({"loss_valid_conf": current_val_loss_conf_avg})
