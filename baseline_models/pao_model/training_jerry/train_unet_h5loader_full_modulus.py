...
def main(cfg: DictConfig) -> float:
    ...
    model = ClimsimUnet(
        num_vars_profile = data.input_series_num,
        num_vars_scalar = data.input_scalar_num,
        num_vars_profile_out = data.target_series_num,
        num_vars_scalar_out = data.target_scalar_num,
        seq_resolution = 64,
        model_channels = 128,
