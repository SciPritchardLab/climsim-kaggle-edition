...
checkpoint_path = '/global/homes/j/jerrylin/scratch/hugging/E3SM-MMF_ne4/saved_models/climsim3_ensembles/convnext/convnext_seed_43/ckpt/ckpt_epoch_7_metric_0.0718.mdlus'
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

# offline inference
save_path =  f'/global/homes/j/jerrylin/scratch/hugging/E3SM-MMF_ne4/saved_models/prelim_comparison/convnext'
