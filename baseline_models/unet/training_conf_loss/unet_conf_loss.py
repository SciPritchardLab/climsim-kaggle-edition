...
@dataclass
class UnetConfLossMetaData(modulus.ModelMetaData):
    name: str = "unet_conf_loss"
    # Optimization
    jit: bool = True
...
class UnetConfLoss(modulus.Module):
    def __init__(
            self, 
        ...
        super().__init__(meta=UnetConfLossMetaData())
    ...
    def forward(self, x):
        ...
        if self.input_padding[1]==0:
            y_pred_profile = pred_x[:,:self.target_profile_num,self.input_padding[0]:]
            y_pred_scalar = pred_x[:,self.target_profile_num:,self.input_padding[0]:]
            y_conf_profile = conf_x[:,:self.target_profile_num,self.input_padding[0]:]
            y_conf_scalar = conf_x[:,self.target_profile_num:,self.input_padding[0]:]
        else:
            y_pred_profile = pred_x[:,:self.target_profile_num,self.input_padding[0]:-self.input_padding[1]]
            y_pred_scalar = pred_x[:,self.target_profile_num:,self.input_padding[0]:-self.input_padding[1]]
            y_conf_profile = conf_x[:,:self.target_profile_num,self.input_padding[0]:-self.input_padding[1]]
            y_conf_scalar = conf_x[:,self.target_profile_num:,self.input_padding[0]:-self.input_padding[1]]
        ...
        y_pred_profile = y_pred_profile.reshape(-1, self.target_profile_num*self.vertical_level_num)
        y_conf_profile = y_conf_profile.reshape(-1, self.target_profile_num*self.vertical_level_num)
