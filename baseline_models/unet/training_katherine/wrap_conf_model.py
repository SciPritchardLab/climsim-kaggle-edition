...
f_torch_model = '/pscratch/sd/k/kfrields/hugging/E3SM-MMF_saved_models/unet_adamW_conf_2/model.mdlus'
save_file_torch = os.path.join('/pscratch/sd/k/kfrields/hugging/E3SM-MMF_saved_models/unet_adamW_conf_2/', 'wrapped_model.pt')
