...
case_prefix = 'unet_seed_43_long'
# exe_refcase = 'ftorch_test'
# Added extra physics_state and cam_out variables.

top_dir  = os.getenv('HOME')
scratch_dir = os.getenv('SCRATCH')
case_dir = f'{scratch_dir}/hugging/E3SM-MMF_ne4/online_runs/climsim3_ensembles/unet'
...
#---------------------------------------------------------------------------------------------------
# MMF_NN_EMULATOR
f_torch_model = '/pscratch/sd/j/jerrylin/hugging/E3SM-MMF_ne4/saved_models/climsim3_ensembles/unet/unet_seed_43/wrapped_model.pt'
