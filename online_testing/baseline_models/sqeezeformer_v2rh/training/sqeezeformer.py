...
@dataclass
class SqeezeformerMetaData(modulus.ModelMetaData):
    name: str = "Sqeezeformer"
    # Optimization
    jit: bool = True
...
class Sqeezeformer(modulus.Module):
    ...
    def __init__(self, col_len, col_not_len, dim=256, head_dim=1024):
        ...
        self.final_dense_pred = nn.Linear(head_dim, 14)
        self.final_dense_confidence = nn.Linear(head_dim, 14) # 20 was for auxilary loss
