...
for years in years_to_try:
    for model_name in model_names.keys():
        plot_online_global_rmse_config_comparison(model_name, years, show=False, save_path=os.path.join(climsim3_figures_save_path_online, 'online_global_rmse_config_comparison'))