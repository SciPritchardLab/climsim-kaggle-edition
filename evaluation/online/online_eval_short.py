...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_mean_file', type=str, default = 'input_mean_v6_pervar.nc')
    parser.add_argument('--input_max_file', type=str, default = 'input_max_v6_pervar.nc')
    parser.add_argument('--input_min_file', type=str, default = 'input_min_v6_pervar.nc')
    parser.add_argument('--output_scale_file', type=str, default = 'output_scale_std_lowerthred_v6.nc')
