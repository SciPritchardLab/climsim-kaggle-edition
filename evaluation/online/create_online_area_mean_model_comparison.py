...
# plot_online_area_mean_model_comparison(config_name, num_years, show = True, save_path = None)

years_to_try = [4,5]
for years in years_to_try:
    for config_name in config_names.keys():
        plot_online_area_mean_model_comparison(config_name, years, show=False, save_path=os.path.join(climsim3_figures_save_path_online, 'online_area_mean_model_comparison'))