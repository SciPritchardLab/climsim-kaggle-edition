...
preds_path = '/global/homes/j/jerrylin/scratch/hugging/E3SM-MMF_ne4/preprocessing/v6/scoring_set/preds/'
...
def preprocessing_v6(data, input_path, target_path):
...
torch_input, reshaped_target, pressures_binned = preprocessing_v6(data, input_path, target_path)
