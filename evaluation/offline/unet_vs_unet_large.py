...
unet_large_path = '/global/homes/j/jerrylin/scratch/hugging/E3SM-MMF_ne4/saved_models/prelim_comparison/unet_large/model.pt'

model_paths = {'unet': unet_path, \
               'unet_large': unet_large_path,}
...
for model_name in model_paths.keys():
    ...
    np.save(preds_path + f'{model_name}_preds_unet_comparison.npy', model_preds[model_name])
...
# Show the plot
plt.tight_layout()
plt.savefig(preds_path + 'r2_lines_unet_comparison.png')
plt.clf()
...
plt.savefig(preds_path + 'press_lat_r2_models_unet_comparison.png', bbox_inches='tight', pad_inches=0.1 , dpi = 300)
plt.clf()